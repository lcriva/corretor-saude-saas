...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-600 via-blue-700 to-purple-700 dark:from-slate-900 dark:via-blue-900 dark:to-slate-950 flex items-center justify-center p-4 transition-colors duration-300">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md p-8 border border-transparent dark:border-gray-700">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-gray-800 dark:text-white">Corretor Saúde Pro</h1>
                    <p className="text-gray-600 dark:text-gray-400 mt-2">Seu assistente inteligente de vendas</p>
                </div>
                ...
                {error && (
                    <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-900/30 text-red-700 dark:text-red-400 px-4 py-3 rounded-lg mb-4">
                        {error}
                    </div>
                )}
